...
const config: Config = {
  title: 'AI Driven Development Book',
  tagline: 'A practical guide to AI-driven software engineering',
  ...
  url: 'https://ai-dev-book.example.com',
    ...
    [
      'classic',
      {
        docs: {
          ...
          // editUrl: 'https://github.com/your-organization/ai-dev-book/tree/main/',
        },
        blog: {
